...
Este escript muestra los inicios y cierres de sesión de todos los usuarios por server/PC. 
Admite un servidor o más de uno. Lo único que tenéis que hacer es editar la línea 7, donde os detallo como poner más de un objeto de tipo dispositivo. 
